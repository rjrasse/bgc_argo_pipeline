...
%  LECTOR DE DATOS BGC-ARGO: Monitoreo de Océano Abierto
%
%  Project: Data Architecture & Biogeochemical Cycles
%  Proyecto: Arquitectura de Datos y Ciclos Biogeoquímicos
%
%  Function: Data Ingestion from Argo NetCDF profiles
%  Función: Ingesta de perfiles NetCDF de flotadores Argo
%
%  Author: Rafael Rasse
%  Created: 2013-07-02
...
function [tmp] = rd_ncread_SO_sector_6901583(fn)
    ...
    % --- TIME & GEOLOCATION / TIEMPO Y GEOLOCALIZACIÓN ---
    % Reference date for julian day conversion / Referencia para días julianos
    ...
    % --- PHYSICAL VARIABLES / VARIABLES FÍSICAS ---
    ...
    % Physical sensors (Adjusted data) / Sensores físicos (Datos ajustados)
    ...
    % --- BIOGEOCHEMICAL & OPTICAL / BIOGEOQUÍMICA Y ÓPTICA ---
